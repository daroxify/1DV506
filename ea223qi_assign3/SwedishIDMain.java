...
public class SwedishIDMain {
    public static void main(String[] args) {
        ...
        if(id1.isFemale()) System.out.println("female.");
        else System.out.println("male.");
        System.out.print(id2.showID() + " is a ");
        if(id2.isFemale()) System.out.println("female.");
        else System.out.println("male.");
        ...
        else System.out.println(id1.showID() + "is not valid");
        if(id4.validID())
            System.out.println(id4.showID() + " is valid");
        else System.out.println(id4.showID() + " is not valid");
        if(id5.validID()) System.out.println(id5.showID() + " is valid");
        else System.out.println(id5.showID() + " is not valid");
    }
}
